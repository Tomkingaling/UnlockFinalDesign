...
// -----------------------------------------------------------------------------
// Self-certification gate for the investor surface (invest. / dd.unlockdd.com).
// Runs on EVERY request to this Pages project. Anything that isn't the gate
// page, its assets, or the certify endpoint requires a valid self-cert cookie;
// otherwise the visitor is bounced back to the gate.
//
...
// Paths reachable WITHOUT certification (the gate itself + its plumbing).
